...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        $stmt = $pdo->prepare("INSERT INTO retailers (name, email, password, phone, address, latitude, longitude) VALUES (?, ?, ?, ?, ?, ?, ?)");
...
<head>
    ...
    <title>Retailer Registration - MedZone</title>
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="text-center mb-0">Retailer Registration</h3>
                    </div>
